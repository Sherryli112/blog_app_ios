    ...
    static func page(title: String, author: String, dateText: String,
        ...
        <style>
          ...
          @media (prefers-color-scheme: dark) {
            :root { --fg:#e9e9ec; --fg2:#9b9ba0; --bg:#121212; }
          }
          * { box-sizing: border-box; }
          html, body { margin:0; padding:0; background:var(--bg); }
          body {
            font-family: "PingFang TC", "PingFang SC", "Heiti TC", -apple-system, system-ui, sans-serif;
          ...
          article h1, article h2, article h3 { line-height:1.4; margin:28px 0 12px; font-weight:800; }
          article h2 { font-size:22px; }
          article h3 { font-size:19px; }
          article a { color:var(--accent); text-decoration:none; }
          article ul, article ol { padding-left:1.3em; }
          article table { width:100%; border-collapse:collapse; display:block; overflow-x:auto; -webkit-overflow-scrolling:touch; }
          article ::-webkit-scrollbar, article::-webkit-scrollbar { width:0; height:0; display:none; }
